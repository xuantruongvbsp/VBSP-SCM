...
| Mục tiêu | Chi tiết | Ưu tiên |
|---|---|---|
| Báo cáo định kỳ | Lịch xuất tự động (tuần/tháng/quý) qua `schedule` + email | 🔴 Cao |
...
| Gửi email tự động | Dùng SMTP NHCSXH, gửi báo cáo cho BGĐ mỗi sáng | 🟠 TB |

### 2.2 Phân tích nâng cao

| Mục tiêu | Chi tiết | Ưu tiên |
|---|---|---|
| Dự báo rủi ro | ML đơn giản (Prophet/ARIMA) dự báo NQH theo PGD | 🟠 TB |
| Phân loại khách hàng | RFM hoặc behavior scoring dựa trên lịch sử trả nợ | 🟠 TB |
| Stress test danh mục | Kịch bản: lãi suất tăng 2%, 5% khách hàng mất khả năng trả nợ | 🟡 Thấp |
...
| Tích hợp với NHCSXH VN | Đồng bộ dữ liệu cấp Trung ương | 🟠 TB |
| SSO/LDAP | Tích hợp xác thực với Active Directory NHCSXH | 🟡 Thấp |
...
| Chatbot nội bộ | Hỏi đáp về quy trình, số liệu, KPI | 🟡 Thấp |
...
┌──────────────────┐  ┌──────────────────┐  ┌──────────────────┐
│ 1.1 Test         │  │ 2.1 Báo cáo tự động│  │ 4.1 API + Tích hợp│
│ 1.2 Performance  │  │ 2.2 Phân tích     │  │ 4.2 Tính năng mới │
│ 1.3 Data Quality │  │ 3.1 Deployment   │  │                   │
│ → Test ≥65%      │  │ 3.2 Backup       │  │                   │
