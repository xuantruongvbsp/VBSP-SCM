...
MAP_TEN_COT = {
    ...
    "tong_diem": "Tổng điểm",
    "diem_nqh": "NQH",
    "diem_gdtx": "Giao dịch xã",
    "diem_thu_no": "Thu nợ",
    "diem_thu_lai": "Thu lãi",
    "diem_tv_tiengui": "TV tiền gửi",
    "diem_ds_tg": "Dư tiền gửi",
}
...
def xuat_pdf(
    ...
    # Header row
    header_cells = [
        Paragraph(MAP_TEN_COT.get(str(c), str(c).replace("_", " ")), ParagraphStyle("th", fontName=fb,
