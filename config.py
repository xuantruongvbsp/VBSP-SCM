...
XA_THON_MAP: dict[str, list[str]] = {
    ...
    'Xã Bầu Hàm': ['Tân Hoa', 'Tân Hợp', 'Tân Việt', 'Cây Điều', 'Tân Lập 1', 'Tân Lập 2', 'Cây Điệp', 'Thuận Trường', 'Thuận Hòa', 'Thuận An', 'Trường An', 'Trung Tâm', 'Lợi Hà', 'Suối Tiên', 'Tân Thành'],
