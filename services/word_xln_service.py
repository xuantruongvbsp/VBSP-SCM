...
# Large template exports moved to word_xln_service_full.py
# (placed at bottom to avoid circular import with _full module)
from services.word_xln_service_full import (
    _tao_word_04xln_v2,
    _tao_word_05xln_v2,
    _add_thanh_phan_tong_hop,
    _add_bang_tong_hop_04_05,
    _add_phan_ky_tong_hop,
