"""UI helpers for tab Xử Lý Rủi Ro — subtab render functions.

Tách từ tabs/tab_xu_ly_rui_ro.py: 3 sub-tab lớn + helpers + constants dùng chung.
"""
